...
bot = Client(
    "bot",
    bot_token=os.environ.get("7461450297:AAFnx5POjTVJCv3vUC_-EvreMFRyUG4QOGQ"),
    api_id=int(os.environ.get("27215374")),
    api_hash=os.environ.get("b4495d7b9db5bb280121b4eeeb68331c")
)
